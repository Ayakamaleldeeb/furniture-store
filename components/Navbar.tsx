...
//     <nav className="bg-white p-4 shadow-md flex flex-col items-center justify-between z-50">
...
//       {isOpen && (
//         <div className="md:hidden flex flex-col items-center w-full mt-4 space-y-4">
//           <Link href="/" className="text-black opacity-50">
//             HOME
//           </Link>
//           <Link href="/about" className="text-black opacity-50">
//             ABOUT
//           </Link>
//           <Link href="/categories" className="text-black opacity-50">
//             CATEGORIES
//           </Link>
//           <Link href="/offers" className="text-black opacity-50">
//             OFFERS
//           </Link>
//           <Link href="/contact" className="text-black opacity-50">
//             CONTACT
//           </Link>
